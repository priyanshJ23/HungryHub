...
export default function Login() {
  ...
  return (
    <div style={{backgroundImage: 'url("https://img.freepik.com/premium-photo/food-background-menu-with-spices-culinary-ingredients-dark-stone-background-cooking-concepts-culinary-background-top-view-free-space-your-text_234595-2347.jpg?w=2000")', height: '100vh', backgroundSize: 'cover' }}>
      <div>
        <Navbar />
      </div>
      <div className='container'>
        <form className='w-50 m-auto mt-5 border bg-dark border-info rounded' onSubmit={handleSubmit}>
          ...
          <Link to="/signup" className="m-3 mx-1 btn btn-info">New User</Link>
        </form>
